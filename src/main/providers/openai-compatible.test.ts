...
describe('isOpenAIChatModel', () => {
  it('keeps chat models and drops other modalities', () => {
    ...
    expect(isOpenAIChatModel('ft:gpt-4o-mini:acme::abc123')).toBe(true)
    expect(isOpenAIChatModel('ft:gpt-4o-mini:acme:image-tagger:abc123')).toBe(true)
    expect(isOpenAIChatModel('gpt-4o-search-preview')).toBe(false)
    expect(isOpenAIChatModel('o3-deep-research')).toBe(true)
  })
})
